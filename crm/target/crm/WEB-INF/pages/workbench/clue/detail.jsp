		...
		<c:forEach items="${clueRemarkList}" var="remark">
			<div class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}${clue.appellation}-${clue.company}</b> <small style="color: gray;"> ${remark.createTime}-由${remark.editFlag=='1'?remark.editBy:remark.createBy}  ${remark.editFlag=='1'?"修改":"创建"} </small>
		...
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table class="table table-hover" style="width: 900px;">
					...
					<tbody>
						<c:forEach items="${relationActivityList}" var="activity">
							<tr>
								<td>${activity.name}</td>
